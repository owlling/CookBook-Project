    ...
    class CookCategoryFirHolder extends CommonHolder<CookCategoryFirStruct>{
        ...
        public void bindData(final CookCategoryFirStruct cook) {
            if(cook.isSelect){
                ...
                relativeBg.setBackgroundColor(CookBookApp.getContext().getResources().getColor(R.color.white));
            }
            else{
                textSelect.setVisibility(View.GONE);
                relativeBg.setBackgroundColor(CookBookApp.getContext().getResources().getColor(R.color.black_alpha_light));
            }
